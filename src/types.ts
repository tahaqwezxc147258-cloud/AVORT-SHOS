...
export interface Banner { id: string; desktopImage: string; mobileImage?: string; title: string; description?: string; buttonLabel?: string; href?: string; productId?: string; imageIndex?: number; isActive: boolean; sortOrder: number; createdAt?: string; updatedAt?: string; }
