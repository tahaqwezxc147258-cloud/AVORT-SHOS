...
CREATE TABLE IF NOT EXISTS "Product" (
  ...
  "specialBoxAvailable" BOOLEAN NOT NULL DEFAULT FALSE,
  "specialBoxPrice" INTEGER NOT NULL DEFAULT 350000,
  "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "OrderItem" (
  ...
  "withSpecialBox" BOOLEAN NOT NULL DEFAULT FALSE,
  "specialBoxPrice" INTEGER NOT NULL DEFAULT 0,
  "packagingLabel" TEXT NOT NULL DEFAULT 'جعبه عادی',
  "priceToman" INTEGER NOT NULL,
